...
//	}
	...
	private onTransitionOutComplete(event:gEvents.PageEvent):void
	{
		...
		if (this._debug)
		{
			console.log("TransitionController::transitionOutComplete: \"" + (<any>event.target).getBranch() + "\"");
		}
	...
	private onTransitionInComplete(event:gEvents.PageEvent):void
	{
		if (this._debug)
		{
			console.log("TransitionController::transitionInComplete: \"" + (<IPageAsset>event.target).getBranch() + "\"");
		}
	...
	private onTransitionComplete(event:gEvents.PageEvent):void
	{
		if (this._debug)
		{
			console.log("TransitionController::transitionComplete: \"" + (<IPageAsset>event.target).getBranch() + "\"");
		}
