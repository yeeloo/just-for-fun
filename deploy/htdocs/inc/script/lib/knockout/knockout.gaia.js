define(["require", "exports", 'knockout', 'lib/gaia/api/Gaia', 'lib/gaia/core/BranchTools'], function (require, exports, ko, Gaia, BranchTools) {
        ...
        KnockoutGaiaGoto.init = function (element, valueAccessor, allBindings, vm, bindingContext) {
            ...
            if (typeof value === 'string') {
                ...
                if (branch.length < value.length) {
                    console.error('string syntax with deeplink is not supported anymore for "' + value + '", use [branch, {}]');
                }
            }
            else {
                branch = value[0];
