define(["require", "exports", 'lib/temple/utils/types/RegExpUtils', './Frame'], function (require, exports, RegExpUtils, Frame) {
    /**
     *
    ...
    var TrackingData = (function () {
        ...
        TrackingData.prototype.parseAfterEffects = function () {
            ...
            // find all frames
            var results = RegExpUtils.pregMatchAll(regexp, this._rawData);
            this._pins = [];
            var pin;
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (results[1][i] == 'Frame') {
                    ...
                    var frame = new Frame(results[2][i]);
