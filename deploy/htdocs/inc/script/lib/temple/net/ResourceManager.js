...
define(["require", "exports", "lib/temple/events/EventDispatcher", "lib/temple/events/BaseEvent", "./resourcemanager/DataEvent", "lib/temple/config/ConfigManager", "app/config/AssetID"], function (require, exports, EventDispatcher, BaseEvent, DataEvent, ConfigManager, AssetID) {
    /**
     * ResourceManager
     *
     * @module Temple
    ...
    var ResourceManager = (function (_super) {
        ...
        ResourceManager.prototype.handleProgress = function (event) {
            this.dispatchEvent(new DataEvent('progress', event));
        };
        /**
         * Returns
         *
        ...
        ResourceManager.prototype.getByID = function (id) {
            var src = ConfigManager.getInstance().getUrl(id);
        ...
        ResourceManager.prototype.getByImageByAssetID = function (id, onLoad) {
            ...
            var src = ConfigManager.getInstance().getUrl(strId);
        ...
        ResourceManager.prototype.getByImageBySrc = function (src, onLoad) {
            ...
            if (this._assets[hashCode] == void 0) {
                ...
                this._assets[hashCode] = ResourceManager.getImageElement(src, function (img) { return _this.dispatchEvent(new DataEvent(eventId, img)); });
            }
            else {
                ...
                if (!hasContent) {
                    ...
                    onLoad.call(null, new DataEvent(eventId, asset));
                }
            }
            return this._assets[hashCode];
        };
        ResourceManager.EVENT_ONLOAD_IMAGE = 'onload_image';
        ResourceManager.cm = ConfigManager.getInstance();
        /**
