...
import DataEvent = require("./resourcemanager/DataEvent");

import IManifest = require("lib/createjs/easeljs/component/interface/IManifest");
import ConfigManager = require("lib/temple/config/ConfigManager");
import AssetID = require("app/config/AssetID");
...
class ResourceManager extends EventDispatcher
{
	...
	public static cm:ConfigManager = ConfigManager.getInstance();
