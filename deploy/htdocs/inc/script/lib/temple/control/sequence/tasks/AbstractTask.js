...
define(["require", "exports", "lib/temple/events/EventDispatcher", "lib/temple/control/sequence/tasks/TaskEvent"], function (require, exports, EventDispatcher, TaskEvent) {
    var AbstractTask = (function (_super) {
        ...
        AbstractTask.prototype.execute = function () {
            ...
            if (this.isExecuting()) {
                ...
                if (this.hasEventListener(TaskEvent.START))
                    this.dispatchEvent(new TaskEvent(TaskEvent.START, this));
        ...
        AbstractTask.prototype.done = function () {
            this._executing = false;
            if (this.hasEventListener(TaskEvent.DONE))
                this.dispatchEvent(new TaskEvent(TaskEvent.DONE, this));
        };
        /**
        ...
        AbstractTask.prototype.fail = function (message) {
            this._executing = false;
            if (this.hasEventListener(TaskEvent.ERROR))
                this.dispatchEvent(new TaskEvent(TaskEvent.ERROR, this, message));
        };
        return AbstractTask;
    })(EventDispatcher);
    return AbstractTask;
