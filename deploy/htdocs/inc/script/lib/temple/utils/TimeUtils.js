define(["require", "exports", 'lib/temple/utils/types/StringUtils'], function (require, exports, StringUtils) {
    ...
    var TimeUtils = (function () {
        ...
        TimeUtils.formatTime2 = function (milliseconds, delimiter) {
            if (delimiter === void 0) { delimiter = ':'; }
            return StringUtils.padLeft((Math.floor(milliseconds / 86400000)).toString(), 2, '0') + delimiter + StringUtils.padLeft((Math.floor(milliseconds / 3600000) % 24).toString(), 2, '0') + delimiter + StringUtils.padLeft((Math.floor(milliseconds / 60000) % 60).toString(), 2, '0') + delimiter + StringUtils.padLeft((Math.floor(milliseconds * .001) % 60).toString(), 2, '0') + '.' + StringUtils.padLeft((Math.round(Math.floor(milliseconds % 1000))).toString(), 3, '0');
        };
        /**
