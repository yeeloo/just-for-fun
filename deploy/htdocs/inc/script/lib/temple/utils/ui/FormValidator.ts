...
export class ValidationRule
{
	 ...
	 * @param {Function} fn
	 */
    public validate( el:HTMLElement[], args:Array<string>, fn:(result:boolean, errorMsg?:string) => void )
    {
...
export class FormValidator
{
    ...
    public static rules:{[id:string]:ValidationRule} =
    {
         ...
         */
        'required': new ValidationRule(['input', 'textarea'], ( el, args, fn ) =>
        {
         ...
         *      </div>
         */
        'range': new ValidationRule(['input', 'textarea'], ( el, args, fn ) =>
        {
         ...
         *      </div>
         */
        'minimum-length': new ValidationRule(['input', 'textarea'], ( el, args, fn ) =>
        {
            var value = $( el ).val() || ''
        ...
        'regexp': new ValidationRule(['input', 'textarea'], ( el, args, fn ) =>
        {
            var value = $( el ).val() || '';
            var regexp:string = $( el ).attr( 'data-pattern' ) || '';
            ...
            var valid:boolean = new RegExp('^(?:' + regexp + ')$').test(value);
     ...
     */
    public static validateForm( el:HTMLFormElement, applyStyles:boolean = true, fn:(success:boolean, errors?:string[]) => void = () => {}):any
    {
