...
define(["require", "exports", 'lib/temple/events/EventDispatcher', 'lib/temple/events/CommonEvent'], function (require, exports, EventDispatcher, CommonEvent) {
    /**
     * @module Temple
    ...
    var LocaleManager = (function (_super) {
        ...
        LocaleManager.getInstance = function () {
            if (!LocaleManager._instance) {
                ...
                window['localeManager'] = LocaleManager._instance;
            }
        ...
        LocaleManager.prototype.setLocale = function (locale) {
            if (this._debug) {
                console.log('LocaleManager::setLocale(', locale, ')');
            }
            if (!locale) {
                return;
            }
        ...
        LocaleManager.prototype.getKeys = function (path, locale) {
            ...
            console.log("getString: no text found for '" + path + "', locale '" + (locale || this._locale) + "'");
        ...
        LocaleManager.prototype.getString = function (id, locale) {
            ...
            console.log("getString: no text found for '" + id + "', locale '" + (locale || this._locale) + "'");
            // nothing found, return empty string.
            return '';
        };
        /**
        ...
        LocaleManager.prototype.addLocaleProvider = function (provider) {
            if (this._debug) {
                console.log('LocaleManager::addLocaleProvider(', provider, ')');
            }
        ...
        LocaleManager.prototype.checkProviders = function (locale) {
            if (this._debug) {
                console.log('LocaleManager::checkProviders(', locale, ')');
            }
