import AbstractLocaleProvider = require('lib/temple/locale/provider/core/AbstractLocaleProvider');
import ILocaleData = require('lib/temple/locale/provider/core/interface/ILocaleData');
import LocaleData = require('lib/temple/locale/provider/core/data/LocaleData');
...
class AbstractExternalLocaleProvider extends AbstractLocaleProvider
{
	...
	public addLocaleFile(locale:string, url:string, preload:boolean = false):void
	{
		if(this._debug)
		{
			console.log('AbstractExternalLocaleProvider::addLocaleFile(', locale, url, preload, ')');
		}
	...
	public findLocaleData(locale:string, name:string, url:string):ILocaleData
	{
		if(this._debug)
		{
			console.log('AbstractExternalLocaleProvider::findLocaleData(', locale, name, url, ')');
		}
...
export = AbstractExternalLocaleProvider;