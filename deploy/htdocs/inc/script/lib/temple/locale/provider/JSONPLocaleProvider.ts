import AbstractJSONLocaleProvider = require('lib/temple/locale/provider/core/AbstractJSONLocaleProvider');
import ILocaleData = require('./core/interface/ILocaleData');
