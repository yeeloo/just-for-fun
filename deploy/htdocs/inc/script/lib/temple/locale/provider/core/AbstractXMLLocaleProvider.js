...
define(["require", "exports", 'lib/temple/locale/provider/core/AbstractExternalLocaleProvider'], function (require, exports, AbstractExternalLocaleProvider) {
    /**
     * @module Temple
    ...
    })(AbstractExternalLocaleProvider);
    return AbstractXMLLocaleProvider;
});
