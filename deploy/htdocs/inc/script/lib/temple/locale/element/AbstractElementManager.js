define(["require", "exports", 'lib/temple/locale/LocaleManager', 'lib/temple/events/CommonEvent'], function (require, exports, LocaleManager, CommonEvent) {
    /**
     * @module Temple
    ...
    var AbstractElementManager = (function () {
        function AbstractElementManager() {
            ...
            this._localeManager.addEventListener(CommonEvent.UPDATE, function () {
