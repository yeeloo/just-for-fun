...
define(["require", "exports", './AbstractElementManager', './data/EaselTextData'], function (require, exports, AbstractElementManager, EaselTextData) {
    /**
     * @module Temple
    ...
    var EaselTextManager = (function (_super) {
        ...
        EaselTextManager.prototype.add = function (element, id, key) {
            _super.prototype.addElement.call(this, new EaselTextData(element, id, key));
        };
        /**
         * @public
