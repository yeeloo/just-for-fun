...
import EaselTextData = require('./data/EaselTextData');
...
class EaselTextManager extends AbstractElementManager
{
	 ...
	 * @param {string} key
	 */
	public add(element:createjs.Text, id:string, key:string)
	{
	 ...
	 */
	public getDataForElement(element:createjs.Text):EaselTextData
	{
	 ...
	 * @param {number} height
	 */
	private _timeoutCache(element:createjs.Text, width:number, height:number):void
	{
