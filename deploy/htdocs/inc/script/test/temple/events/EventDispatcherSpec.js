define(["require", "exports", 'lib/temple/events/BaseEvent', 'lib/temple/events/EventDispatcher'], function (require, exports, BaseEvent, EventDispatcher) {
    //import config = require('app/config/config');
    describe('EventDispatcher', function () {
        var type1 = "a";
        var type2 = "b";
        var event1 = new BaseEvent(type1);
        var event2 = new BaseEvent(type2);
        var dispatcher;
        var output;
