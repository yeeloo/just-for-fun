...
<head>
	...
	<meta name="document-base" content="<%=basepath()%>" /><!-- this is used for history, absolute uri to your 'index' -->
	<base href="<%=basepath()%>" /><!-- change this path to cdn or append version folder -->
...
<body data-gaia-container="main">
	...
	<script src="inc/script/app/config/requirejs.config.js"></script>
	<script src="inc/script/lib/require/require.js" data-main="app/Main"></script>
